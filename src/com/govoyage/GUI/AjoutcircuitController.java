 ...
 * @author dell
 */
public class AjoutcircuitController implements Initializable {
    @FXML
    ...
    @FXML
    public void AjouterCircuit(ActionEvent event) throws IOException{
       ...
       // System.out.println(villedepart.getValue().toString());
        
        if ( hd.insertCircuit(h)) {
