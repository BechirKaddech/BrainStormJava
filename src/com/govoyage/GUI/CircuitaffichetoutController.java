 ...
 * @author dell
 */
public class CircuitaffichetoutController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (int i = 0; i < listecircuit.size(); i++) {
                pane.add(loadOnePays(listecircuit.get(i))); 
    ...
    private Pane loadOnePays(circuitvip c) {

        circuitvipDAO crDAO = new circuitvipDAO();
        villeDAO DAO = new villeDAO();

        Pane pane = new Pane(); 
        int im = DAO.findVilleImage(c.getDestination1().getId());
        String pai = DAO.SelectImage(im);
        File ff = new File("c:/wamp/www/VersionFinale/web/uploads/" + pai);
        ...
        Label noncircuit = new Label(c.getNomcircuit());
        Label dest1 = new Label("1ere Destination:\n"+c.getDestination1().getNom());
        Label dest2 = new Label("2eme Destination:\n"+c.getDestination2().getNom());
        Label dest3  = new Label("3eme Destination:\n" +c.getDestination3().getNom());
        Label villdep = new Label("Depart: "+c.getVilledepart().getNom());
        ...
        btn.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    Parent root = FXMLLoader.load(getClass().getResource("Circuitaffichedetaille.fxml"));
        ...
        double Lati =c.getLatitudevd();
        String la =String.valueOf(Lati);
        double Long =c.getLongitudevd();
