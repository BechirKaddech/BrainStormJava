 ...
 * @author dell
 */
public class SejouraffichetoutController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        sejourDAO crDAO = new sejourDAO();

        ObservableList<Pane> pane = FXCollections.observableArrayList();
        List<sejour> lista = crDAO.displayAllsejour();
    ...
    private Pane loadOnePays(sejour c) {
        ...
        Label noncircuit = new Label(c.getVille().getNom());
        Label dest1 = new Label("Hotel:\n"+c.getHotel().getNomHotel());
        Label dest2 = new Label("Date depart\n: "+c.getDateDepart());
        Label dest3  = new Label("Date arrivée:\n" +c.getDateArrive());
        Label villdep = new Label("Prix:\n"+c.getPrix());
