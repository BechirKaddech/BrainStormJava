package com.govoyage.ServiceMeteo;

import com.govoyage.GUI.*;
import com.govoyage.ServiceMeteo.FIOAlerts;
import com.govoyage.ServiceMeteo.FIOCurrently;
import com.govoyage.ServiceMeteo.FIOFlags;
...
public class FIOLibTest {
	...
	public static void main(String[] args) {
		...
		fio.getForecast("36.850678" , "10.182272");
		...
		System.out.println("\n");
                ...
                System.out.println("ici: "+currently.get().getByKey(f[10]));
/*
		//Minutely data
